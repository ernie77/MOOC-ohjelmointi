...
public class KirjastonTietojarjestelmaTest<_Kirja> {
    ...
    private String nimikeMetodi = "nimike";
    ...
    private String haeKirjaNimikkeellaMetodi = "haeKirjaNimikkeella";
    ...
    public void luokallaKirjaKolmiparametrinenKonstruktori() throws Throwable {
        ...
        assertTrue("Määrittele luokalle " + klassName + " julkinen konstruktori: public " + klassName + "(String nimike, String julkaisija, int julkaisuvuosi)", ctor.isPublic());
        ctor.invoke("Kalevala", "Karjalan Perinneseura", 1700);
    }

    @Test
    @Points("118.1")
    public void kirjanNimikeMetodi() throws Throwable {
        String metodi = nimikeMetodi;
        String klassName = kirjaLuokka;
        Reflex.ClassRef<Object> klass = Reflex.reflect(klassName);
    ...
    @Test
    @Points("118.1")
    public void kirjanNimikeMetodi2() throws Throwable {
        String metodi = nimikeMetodi;
        String klassName = kirjaLuokka;
        Reflex.ClassRef<Object> klass = Reflex.reflect(klassName);
    ...
    public void kirjanMetodiToStringAntaaKirjanTiedot() throws Throwable {
        assertFalse("Tee luokalle Kirja toString-metodi", luoKirja("nimike", "julkaisija", 51).toString().contains("@"));

        try {
            Object kirja = luoKirja("nimike", "julkaisija", 51);
            String tulos = ReflectionUtils.invokeMethod(String.class, ReflectionUtils.requireMethod(kirjaClass, "toString"), kirja);

            Assert.assertTrue(tulos.contains("nimike") && tulos.contains("julkaisija") && tulos.contains("" + 51));
        } catch (Throwable t) {
    ...
    @Test
    @Points("118.3")
    public void kirjastollaHaeNimikkeellaMetodi() throws Throwable {
        String metodi = haeKirjaNimikkeellaMetodi;
        String klassName = kirjastoLuokka;
        Reflex.ClassRef<Object> klass = Reflex.reflect(klassName);

        Object k = newKirjasto(klass);

        assertTrue("tee luokalle " + klassName + " metodi public ArrayList<Kirja> " + metodi + "(String nimike) ", klass.method(k, metodi)
                .returning(ArrayList.class).taking(String.class).isPublic());

        String c = ""
                + "Kirjasto k = new Kirjasto(); \n"
                + "k.haeNimikkeella(\"Java\")";
    ...
    @Test
    @Points("118.3")
    public void kirjastonHaeKirjaNimikkeella() throws Throwable {
        String metodi = lisaaKirjaMetodi;
        String klassName = kirjastoLuokka;
        Reflex.ClassRef<Object> klass = Reflex.reflect(klassName);
        Reflex.ClassRef<_Kirja> _KirjaRef = Reflex.reflect(kirjaLuokka);
        ...
        String code = c+"k.haeNimikkeella(\"Java\")\n";

        String v = "\nVirheen aiheuttanut koodi " + code;

        ArrayList lista = klass.method(k, haeKirjaNimikkeellaMetodi).returning(ArrayList.class).taking(String.class).withNiceError(v).invoke("Java");
        ...
        code = c+"k.haeNimikkeella(\"Kahvi\")\n";

        v = "\nVirheen aiheuttanut koodi " + code;

        lista = klass.method(k, haeKirjaNimikkeellaMetodi).returning(ArrayList.class).taking(String.class).withNiceError(v).invoke("Kahvi");

        assertFalse("Koodin\n"+code+"palauttaman lista on null", lista==null);
        assertEquals("Koodin\n"+code+"palauttaman listan pituus väärä",0, lista.size());

        code = c+"k.haeNimikkeella(\"Test Driven\")\n";

        v = "\nVirheen aiheuttanut koodi " + code;

        lista = klass.method(k, haeKirjaNimikkeellaMetodi).returning(ArrayList.class).taking(String.class).withNiceError(v).invoke("Test Driven");
    ...
    @Test
    @Points("118.3")
    public void kirjastollaHaeNimikkeellaJulkaisijalla() throws Throwable {
        ...
        String c = ""
                + "Kirjasto k = new Kirjasto(); \n"
                + "k.haeNimikkeella(\"Microsoft Press\")";
    ...
    @Test
    @Points("118.3")
    public void kirjastollaHaeNimikkeellaJulkaisuvuodella() throws Throwable {
    ...
    private Object luoKirja(String nimike, String julkaisija, int julkaisuvuosi) throws Throwable {
        Constructor kirjaConstructor = ReflectionUtils.requireConstructor(kirjaClass, String.class, String.class, int.class);
        return ReflectionUtils.invokeConstructor(kirjaConstructor, nimike, julkaisija, julkaisuvuosi);
    }
