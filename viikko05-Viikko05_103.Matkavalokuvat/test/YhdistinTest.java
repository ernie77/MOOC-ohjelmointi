...
public class YhdistinTest {
    ...
    private Kuva yhdistaKuvat(String yhdistinTyyppi, String... kuvapolut) {
        ...
        try {
            return Reflex.reflect(klass).method("yhdistaKuvat").returning(Kuva.class).taking(ArrayList.class).invokeOn(yhdistin, kuvat);
        } catch (Throwable t) {
            fail("Olethan luonut luokalle Yhdistin metodin \"yhdistaKuvat\", joka palauttaa Kuva-tyyppisen listan, ja joka saa parametrina ArrayList<Kuva>-listan?");
        }
