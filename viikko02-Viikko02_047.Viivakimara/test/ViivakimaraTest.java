...
//
    ...
    public void piirraPieniNelio() throws Throwable {
        ...
        List<Point> sijainnit = getSijainnit();
        sijainnit = new ArrayList<Point>(new HashSet<Point>(sijainnit));
        Assert.assertTrue("Kun metodia piirraNelio kutsutaan parametrilla 3, robotin tulee piirtää neliö, jonka sivujen pituus on 2.", sijainnit.size() == 8);
        ...
        Assert.assertTrue("Kun metodia piirraNelio kutsutaan parametrilla 4, tulee robotin piirtää neliö, jonka sivujen pituudet ovat 4. Piirrä neliö siten, että robotti kääntyy aina päädyssä oikealle.", sijainnit.isEmpty());
    }
