...
public class Arvauspeli {
    ...
    public void pelaa(int alaraja, int ylaraja) {
        ...
        while (alaraja != ylaraja) {
            if (onkoSuurempiKuin(keskiarvo(ylaraja, alaraja))) {
                alaraja = keskiarvo(ylaraja, alaraja) + 1;
            } else {
                ylaraja = keskiarvo(ylaraja, alaraja);
            }
        }
    ...
    public boolean onkoSuurempiKuin(int luku) {
        System.out.println("Onko lukusi suurempi kuin " + luku + " luku? (k/e)");
