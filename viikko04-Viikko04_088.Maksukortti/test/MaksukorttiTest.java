...
public class MaksukorttiTest {
    ...
    public void montaKorttia() {
        ...
        for (String rivi : rivit) {
            assertTrue("Tulosta kortin tietojen kanssa saman rivin alussa kortin omistaja! Muista poistaa yliääräinen koodi pääohjelmasta kun teet tehtävää 88.6. ", rivi.toLowerCase().contains("pek") || rivi.toLowerCase().contains("mat"));
